...
<head>
  <meta charset="utf-8">
  <title>Search keyword for a Customer within a date range.</title>
	  ...
	  $(function() {
	    $( "input[type=submit]" )
	      ...
	      .click(function( event ) {
			...
			$.get(
				'top_keywords',
				{"from_date": from, "to_date": to, 'customer': selected_customer, 'size': selected_size},
				function(responsejson){
					var json_table = new google.visualization.Table(document.getElementById('orgchart'));
	      			...
	      			var options = {
         				 title: 'Customer Keyword Distribution',
         				 is3D: true
        			};
        			...
        			var options = {
          title: 'Customer Keyword Histogram'
        };
